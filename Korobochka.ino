...
const unsigned char wikipedia_logo [] PROGMEM = {
	// 'wikipedia, 34x34px
	
};

const unsigned char search_logo [] PROGMEM = {
	// 'search_logo, 34x34px
	
};
...
struct {
  void play() {
    ...
    while(true) {
      word = korobkaKeyboard.play(word);
      message("Getting description\nfrom search...", 1);
      url = "https://duckduckgo-duckduckgo-zero-click-info.p.rapidapi.com/?skip_disambig=1&no_redirect=1&no_html=1&format=json&q=" + word;
      http.begin(url);
      http.addHeader("X-RapidAPI-Key", rapidAPIKey);
      http.addHeader("X-RapidAPI-Host", "duckduckgo-duckduckgo-zero-click-info.p.rapidapi.com");
      int httpCode = http.GET();
...
const unsigned char car_eyes [] PROGMEM = {
	// 'car_eyes, 128x64px
	...
	0x03, 0xff, 0xff, 0xf8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1f, 0xff, 0xff, 0xc0, 
	...
	0x07, 0xff, 0xff, 0xff, 0xfc, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3f, 0xff, 0xff, 0xff, 0xe0, 
	0x03, 0xff, 0xff, 0xff, 0xfc, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3f, 0xff, 0xff, 0xff, 0xc0, 
	0x01, 0xff, 0xff, 0xff, 0xfc, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x3f, 0xff, 0xff, 0xff, 0x80, 
	...
	0x00, 0x00, 0x3f, 0xff, 0xff, 0x80, 0x00, 0x00, 0x00, 0x00, 0x01, 0xff, 0xff, 0xfc, 0x00, 0x00, 
	...
	, 
